...
resource "aws_subnet" "private" {
  ...
  availability_zone       = var.azs[count.index]
  map_public_ip_on_launch = false # Private Subnet은 Public IP를 할당하지 않음
...
# Private Route Table (NAT Gateway 필요 시 추가)
# 현재는 NAT Gateway 없이 Private Subnet 간 통신만 가능하도록 설정
...
# Add route to NAT Gateway in the private route table
